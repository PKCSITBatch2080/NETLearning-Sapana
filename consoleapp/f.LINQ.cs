...
class LINQLearner
{
    void Learn()
    {
        ...
        var S1 = new Student("Sapana", 2, new DateTime(1998,12,12)); //yesko datatype Student hunxa
        ...
        List<Student> students = [S1, S2, S3, S4, S5];  //list of Students
        ...
        //Get squares of even numbers only
         ...
         // where le nikaleko even number lai select le operation garxa
